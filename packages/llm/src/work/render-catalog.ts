...
export const RENDER_CARDS_DESCRIPTION = [
  ...
  "- KeyFigures: cardless ruled evidence strip. Props items[{label,value,sub?,basis?,asOf?,source?}].",
  ...
  "Prefer KeyFigures over MetricCard for headline answer numbers. MetricCard is",
  "reserved for a figure that genuinely needs mood or chart context.",
  "If sandbox network access is denied, render only the denial/recovery facts.",
